...
import { Trash2, Plus, Eye, EyeOff, FileText, MessageSquare, GripVertical } from 'lucide-react';
    ...
    <div ref={setNodeRef} style={style} className="bg-memopyk-cream/20 rounded-lg p-4 border border-memopyk-cream/40">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          ...
          <div className="text-memopyk-navy font-medium">{faq.questionEn}</div>
        </div>
        <div>
          <div className="text-xs font-semibold text-memopyk-blue uppercase tracking-wide mb-2">Question Française</div>
          <div className="text-memopyk-navy font-medium">{faq.questionFr}</div>
        </div>
      </div>
        ...
        <div className="mt-6 pt-6 border-t border-memopyk-cream">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-memopyk-cream/50 rounded-lg p-3 text-memopyk-navy">
                {faq.answerEn}
              </div>
            </div>
            <div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                      <div className="space-y-4">
                                        ...
                                        <Textarea
                                          ...
                                          value={newFaqData.answerEn}
                                          onChange={(e) => setNewFaqData({ ...newFaqData, answerEn: e.target.value })}
                                          rows={4}
                                        />
                                      </div>
                                      <div className="space-y-4">
                                        ...
                                        <Textarea
                                          ...
                                          value={newFaqData.answerFr}
                                          onChange={(e) => setNewFaqData({ ...newFaqData, answerFr: e.target.value })}
                                          rows={4}
                                        />
                                      </div>
                                    </div>
