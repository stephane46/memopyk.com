...
export default function CookiePolicy() {
  ...
  return (
    <div className="min-h-screen bg-memopyk-cream">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-20">
        <div className="bg-memopyk-cream rounded-lg shadow-lg p-8 border border-memopyk-blue/10">
          <h1 className="text-3xl font-bold text-memopyk-navy font-poppins mb-8">{legalContent[language].cookiePolicy.title}</h1>
          
          {legalContent[language].cookiePolicy.sections.map((section: any, index: number) => (
          ...
          <p className="text-sm text-memopyk-blue-light mt-8">
            Last updated: {legalContent[language].cookiePolicy.lastUpdated}
          </p>
        </div>
      </main>
